module.exports = {
  ...
  verbose: true,
  collectCoverageFrom: [
    'libs/assignments/haptik/src/lib/**/*.{js,jsx,ts,tsx}',
    '!libs/assignments/haptik/src/lib/**/styles.{js,jsx,ts,tsx}',
    // Co-located specs are test code, not sources to measure.
    '!libs/assignments/haptik/src/lib/**/*.test.{js,jsx,ts,tsx}',
  ],
  ...
  moduleNameMapper: {
    ...
    '^@my-portfolio/valory$': '<rootDir>/libs/assignments/valory/src/index.ts',
    '^@my-portfolio/qiibee$': '<rootDir>/libs/assignments/qiibee/src/index.ts',
    ...
    '^@my-portfolio/cogsy$': '<rootDir>/libs/assignments/cogsy/src/index.ts',
    '^@my-portfolio/taikai$': '<rootDir>/libs/assignments/taikai/src/index.ts',
    '^@my-portfolio/fynd$': '<rootDir>/libs/assignments/fynd/src/index.ts',
    '^@my-portfolio/haptik$': '<rootDir>/libs/assignments/haptik/src/index.ts',
    '^@my-portfolio/plaza$': '<rootDir>/libs/assignments/plaza/src/index.ts',
    '^@my-portfolio/appbase$': '<rootDir>/libs/assignments/appbase/src/index.ts',
